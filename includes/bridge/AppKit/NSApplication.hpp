...
namespace NS
{
	...
	class ApplicationDelegate
	{
		public:
			...
			virtual bool			applicationShouldTerminate( class Application* pSender ) { return false; }
	};
...
_NS_INLINE void NS::Application::setDelegate( const ApplicationDelegate* pAppDelegate )
{
	...
	class_addMethod( (Class)_NS_PRIVATE_CLS( NSValue ), _APPKIT_PRIVATE_SEL( applicationShouldTerminate_ ), (IMP)shouldTerminate, "B@:@" );
...
{
	Object::sendMessage< void >( this, _APPKIT_PRIVATE_SEL( stop ), pSender );
}
